      ...
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8" aria-label="Main">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a
            ...
            className="rounded-full bg-primary-500 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-primary-700"
          >
            {siteConfig.ctas.demo.label}
          </a>
          <a
            href={siteConfig.ctas.login.href}
            className="rounded-full border border-primary-500 px-5 py-2.5 text-sm font-semibold text-primary-600 transition-colors hover:bg-primary-50"
          >
      ...
      {open && (
        <div className="border-t border-gray-100 bg-white px-4 pb-6 pt-2 md:hidden">
          ...
          <div className="mt-3 flex flex-col gap-3">
            <a href={siteConfig.ctas.demo.href} className="rounded-full bg-primary-500 px-5 py-2.5 text-center text-sm font-semibold text-white">
              {siteConfig.ctas.demo.label}
            </a>
            <a href={siteConfig.ctas.login.href} className="rounded-full border border-primary-500 px-5 py-2.5 text-center text-sm font-semibold text-primary-600">
              {siteConfig.ctas.login.label}
            </a>
          </div>
        </div>
