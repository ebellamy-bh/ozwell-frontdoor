...
export default function CertificationBand({ eyebrow, title, description, badges, image }: CertificationBandProps) {
  return (
        ...
        <div className="rounded-3xl bg-gradient-to-br from-[#24c1fc] to-[#0890ed] px-8 py-12 text-white sm:px-12">
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="flex justify-center">
              <Image src={image.src} alt={image.alt} width={image.width} height={image.height} className="h-64 w-auto" />
            </div>
            <div>
              <p className="text-sm font-semibold uppercase tracking-wide text-white/90">{eyebrow}</p>
